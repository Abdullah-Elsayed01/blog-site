...
export default function Post() {
  return (
    <>
      <article className="mb-3 post mx-auto max-w-[300px] border border-grey-100/50 rounded-md">
        <div className="post-img">
          <img className='rounded-md' src="https://lp-cms-production.imgix.net/2023-03/shutterstockRF_300215978.jpg" alt="nature-picture" />
        </div>
